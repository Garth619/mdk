    ...
    <div id='sec-five-slider'>
      ...
      <div class='sec-five-slide'>
        ...
        <span class='sec-five-slide-descrip'>Always took the time to go over every detail of the case thoroughly and
          guided me all along. Got me exactly what I deserved! Very pleased with his work. I highly recommend Sargon at
        ...
        <div class='sec-five-slide-icon-wrapper'>
          ...
          <img id='sec-five-slide-icon' src='<?php bloginfo('template_directory');?>/images/google-logo.png' alt='' />
      ...
      <div class='sec-five-slide'>
        ...
        <span class='sec-five-slide-descrip'>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
